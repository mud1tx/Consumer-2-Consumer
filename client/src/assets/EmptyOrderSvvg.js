      ...
      <div className="flex items-center justify-center flex-col h-screen">
        <div>
          <svg
            ...
            width="100%"
            height="100%"
            viewBox="0 0 885.55805 557.51874"
          ...
          >
            ...
            <path
              ...
              transform="translate(-157.22097 -171.24063)"
              fill="#e6e6e6"
            />
            <rect
              x="76.75322"
        ...
        <div>
        <h1 className="text-lg text-center  md:text-4xl capitalize font-Poppins font-semibold text-svg_color mt-4 ">Haven't order anything yet</h1>
        </div>
      </div>
    </>
  );
