  ...
  return (
    <>
      <div className="flex flex-col h-screen p-2 items-center justify-center">
        <div>
          ...
          >
            ...
            <path
              ...
              fill="#fff"
            />
            <circle cx="694.19401" cy="614.02963" r="87.85039" fill="#5ec576" />
            <path
        ...
        <div>
        <h1 className="text-lg text-center  md:text-4xl capitalize font-Poppins font-semibold text-svg_color mt-4 ">   You Haven't Add Any Product </h1>
        </div>
      </div>
    </>
  );
