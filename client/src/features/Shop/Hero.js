    ...
    <div className="bg-main_color-200">
      <div className="flex flex-col lg:flex-row items-stretch justify-between lg:px-0 px-6 pb-10 2xl:mx-auto 2xl:container">
        ...
        <div className="bg-main_color-1000  dark:bg-gray-800 lg:w-1/2 lg:ml-12 lg:p-14 p-8 flex items-center">
          <div>
            <h1 className="dark:text-white md:w-8/12 lg:w-10/12 xl:8/12 2xl:w-8/12 w-full xl:text-6xl sm:text-5xl text-4xl font-semibold text-main_color-200 capitalize">
              {" "}
              Consumer To Consumer
            </h1>
            <p className="dark:text-gray-300 md:w-9/12 lg:w-11/12 xl:w-10/12 2xl:9/12 text-base leading-normal text-main_color-200 mt-5">
              ...
              is conducted via online companies.
            </p>
            <button
              className="dark:bg-white rounded-sm dark:hover:bg-gray-400 
